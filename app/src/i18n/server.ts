...
const resources = {
  en: { emails: enEmails, data: enData },
  de: { emails: deEmails, data: deData },
  es: { emails: esEmails, data: esData },
  fr: { emails: frEmails, data: frData },
  pt: { emails: ptEmails, data: ptData },
};
