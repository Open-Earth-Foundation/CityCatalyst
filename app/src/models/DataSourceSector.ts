...
export type DataSourceSectorCreationAttributes = Optional<
  DataSourceSectorAttributes,
  DataSourceSectorOptionalAttributes
>;

export class DataSourceSector
  extends Model<DataSourceSectorAttributes, DataSourceSectorCreationAttributes>
  implements DataSourceSectorAttributes
{
  datasourceId!: string;
  sectorId!: string;
  created?: Date;
        ...
        indexes: [
          {
            ...
            unique: true,
            fields: [{ name: "datasource_id" }, { name: "sector_id" }],
          },
        ],
      },
    );
