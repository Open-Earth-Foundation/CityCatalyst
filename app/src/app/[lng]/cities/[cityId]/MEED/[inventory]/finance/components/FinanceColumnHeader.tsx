...
import { FOCUS_RING, type SortDirection } from "../labels";
...
export interface FinanceColumnHeaderProps {
  label: string;
  width: string;
  align?: "start" | "end";
...
/**
 * A table header that reads as one: neutral fill, uppercase overline label, a
 * rule under it, an explicit width, and a real sort control on the score column
 * instead of a silently pre-sorted table.
 */
export function FinanceColumnHeader({
  label,
  width,
  align = "start",
  onSort,
