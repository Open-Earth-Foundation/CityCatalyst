...
const CreateModuleModal: FC<CreateModuleModalProps> = ({
  isOpen,
  onClose,
  onOpenChange,
  t,
}) => {
  const [createModule, { isLoading }] = api.useCreateModuleMutation();

  const { showErrorToast } = UseErrorToast({
    title: t("module-create-error"),
  });
  const { showSuccessToast } = UseSuccessToast({
    title: t("module-created"),
    duration: 1200,
  });
