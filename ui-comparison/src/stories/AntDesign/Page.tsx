    ...
    <div className={`CityDashboard w-[1440px] h-[2755px] relative bg-white ${poppins.className}`}>
      ...
      <div className="px-[175px] block w-full">
        ...
        <div className="Frame26976 left-[175px] top-[644px] absolute flex-col justify-start items-start gap-12 inline-flex">
          ...
          <div className="Datasourcecard max-w-[1160px] h-[120px] w-full px-6 py-8 bg-white rounded-lg border border-violet-100 flex-col justify-center items-start gap-6 flex">
            <div className="Frame26966 self-stretch w-full items-center justify-between gap-6 inline-flex">
              ...
              <Button type="primary" shape="round" icon={<PiNotePencil className="text-blue-700" />} className="border border-blue-700 rounded-[50px] w-64 bg-white">
                <span className="text-center text-blue-700 text-[13px] font-semibold uppercase leading-none tracking-widest">edit inventory goal</span>
              </Button>
          ...
          <div className="Datasourcecard max-w-[1160px] w-full px-6 py-8 bg-white rounded-lg border border-violet-100 flex-col justify-start items-end gap-6">
            ...
            <div className="Divider self-stretch h-[0px] border-violet-100"></div>
            <div className="Frame26982 self-stretch p-6 rounded-lg justify-start w-full items-center gap-12 inline-flex">
              <div className="Frame26966 grow shrink basis-0 h-[142px] justify-between w-full items-center gap-12 flex">
                <div className="Frame27093 grow shrink basis-0 flex-col justify-start items-start gap-4 inline-flex">
                  <div className="Frame26973 self-stretch justify-start items-start gap-4 inline-flex">
                    <div className="Trash2 w-8 h-8 relative">
                      <PiTrashLight size={32} className="text-blue-700" />
                    </div>
                    <div className="Frame26973 grow basis-0 flex-col justify-start items-start gap-4 inline-flex">
                      <div className="Frame26973 justify-start items-center gap-2 inline-flex">
