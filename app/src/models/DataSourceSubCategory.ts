...
export type DataSourceSubCategoryId =
  DataSourceSubCategory[DataSourceSubCategoryPk];
export type DataSourceSubCategoryOptionalAttributes = "created" | "lastUpdated";
export type DataSourceSubCategoryCreationAttributes = Optional<
  DataSourceSubCategoryAttributes,
  DataSourceSubCategoryOptionalAttributes
>;
...
export class DataSourceSubCategory
  ...
  >
  implements DataSourceSubCategoryAttributes
{
  datasourceId!: string;
  subcategoryId!: string;
  created?: Date;
        ...
        indexes: [
          {
            ...
            unique: true,
            fields: [{ name: "datasource_id" }, { name: "subcategory_id" }],
          },
        ],
      },
    );
