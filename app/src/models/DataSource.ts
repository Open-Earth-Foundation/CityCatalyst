...
export type DataSourceOptionalAttributes = "name" | "url" | "description" | "accessType" | "geographicalLocation" | "latestAccountingYear" | "frequencyOfUpdate" | "spacialResolution" | "language" | "accessibility" | "dataQuality" | "notes" | "units" | "methodologyUrl" | "publisherId" | "retrievalMethod" | "apiEndpoint" | "created" | "lastUpdated";
...
export class DataSource extends Model<DataSourceAttributes, DataSourceCreationAttributes> implements DataSourceAttributes {
  ...
  setActivitydataIdActivityData!: Sequelize.BelongsToManySetAssociationsMixin<ActivityData, ActivityDataId>;
  addActivitydataIdActivityDatum!: Sequelize.BelongsToManyAddAssociationMixin<ActivityData, ActivityDataId>;
  addActivitydataIdActivityData!: Sequelize.BelongsToManyAddAssociationsMixin<ActivityData, ActivityDataId>;
  createActivitydataIdActivityDatum!: Sequelize.BelongsToManyCreateAssociationMixin<ActivityData>;
  removeActivitydataIdActivityDatum!: Sequelize.BelongsToManyRemoveAssociationMixin<ActivityData, ActivityDataId>;
  removeActivitydataIdActivityData!: Sequelize.BelongsToManyRemoveAssociationsMixin<ActivityData, ActivityDataId>;
  hasActivitydataIdActivityDatum!: Sequelize.BelongsToManyHasAssociationMixin<ActivityData, ActivityDataId>;
  hasActivitydataIdActivityData!: Sequelize.BelongsToManyHasAssociationsMixin<ActivityData, ActivityDataId>;
  ...
  setEmissionsFactorIdEmissionsFactors!: Sequelize.BelongsToManySetAssociationsMixin<EmissionsFactor, EmissionsFactorId>;
  addEmissionsFactorIdEmissionsFactor!: Sequelize.BelongsToManyAddAssociationMixin<EmissionsFactor, EmissionsFactorId>;
  addEmissionsFactorIdEmissionsFactors!: Sequelize.BelongsToManyAddAssociationsMixin<EmissionsFactor, EmissionsFactorId>;
  createEmissionsFactorIdEmissionsFactor!: Sequelize.BelongsToManyCreateAssociationMixin<EmissionsFactor>;
  removeEmissionsFactorIdEmissionsFactor!: Sequelize.BelongsToManyRemoveAssociationMixin<EmissionsFactor, EmissionsFactorId>;
  removeEmissionsFactorIdEmissionsFactors!: Sequelize.BelongsToManyRemoveAssociationsMixin<EmissionsFactor, EmissionsFactorId>;
  hasEmissionsFactorIdEmissionsFactor!: Sequelize.BelongsToManyHasAssociationMixin<EmissionsFactor, EmissionsFactorId>;
  hasEmissionsFactorIdEmissionsFactors!: Sequelize.BelongsToManyHasAssociationsMixin<EmissionsFactor, EmissionsFactorId>;
  ...
  removeGhgIdGhgs!: Sequelize.BelongsToManyRemoveAssociationsMixin<GHGs, GHGsId>;
  ...
  setMethodologyIdMethodologies!: Sequelize.BelongsToManySetAssociationsMixin<Methodology, MethodologyId>;
  addMethodologyIdMethodology!: Sequelize.BelongsToManyAddAssociationMixin<Methodology, MethodologyId>;
  addMethodologyIdMethodologies!: Sequelize.BelongsToManyAddAssociationsMixin<Methodology, MethodologyId>;
  createMethodologyIdMethodology!: Sequelize.BelongsToManyCreateAssociationMixin<Methodology>;
  removeMethodologyIdMethodology!: Sequelize.BelongsToManyRemoveAssociationMixin<Methodology, MethodologyId>;
  removeMethodologyIdMethodologies!: Sequelize.BelongsToManyRemoveAssociationsMixin<Methodology, MethodologyId>;
  hasMethodologyIdMethodology!: Sequelize.BelongsToManyHasAssociationMixin<Methodology, MethodologyId>;
  hasMethodologyIdMethodologies!: Sequelize.BelongsToManyHasAssociationsMixin<Methodology, MethodologyId>;
  ...
  setReportinglevelIdReportingLevels!: Sequelize.BelongsToManySetAssociationsMixin<ReportingLevel, ReportingLevelId>;
  addReportinglevelIdReportingLevel!: Sequelize.BelongsToManyAddAssociationMixin<ReportingLevel, ReportingLevelId>;
  addReportinglevelIdReportingLevels!: Sequelize.BelongsToManyAddAssociationsMixin<ReportingLevel, ReportingLevelId>;
  createReportinglevelIdReportingLevel!: Sequelize.BelongsToManyCreateAssociationMixin<ReportingLevel>;
  removeReportinglevelIdReportingLevel!: Sequelize.BelongsToManyRemoveAssociationMixin<ReportingLevel, ReportingLevelId>;
  removeReportinglevelIdReportingLevels!: Sequelize.BelongsToManyRemoveAssociationsMixin<ReportingLevel, ReportingLevelId>;
  hasReportinglevelIdReportingLevel!: Sequelize.BelongsToManyHasAssociationMixin<ReportingLevel, ReportingLevelId>;
  hasReportinglevelIdReportingLevels!: Sequelize.BelongsToManyHasAssociationsMixin<ReportingLevel, ReportingLevelId>;
  ...
  setScopeIdScopes!: Sequelize.BelongsToManySetAssociationsMixin<Scope, ScopeId>;
  addScopeIdScope!: Sequelize.BelongsToManyAddAssociationMixin<Scope, ScopeId>;
  addScopeIdScopes!: Sequelize.BelongsToManyAddAssociationsMixin<Scope, ScopeId>;
  createScopeIdScope!: Sequelize.BelongsToManyCreateAssociationMixin<Scope>;
  removeScopeIdScope!: Sequelize.BelongsToManyRemoveAssociationMixin<Scope, ScopeId>;
  removeScopeIdScopes!: Sequelize.BelongsToManyRemoveAssociationsMixin<Scope, ScopeId>;
  hasScopeIdScope!: Sequelize.BelongsToManyHasAssociationMixin<Scope, ScopeId>;
  hasScopeIdScopes!: Sequelize.BelongsToManyHasAssociationsMixin<Scope, ScopeId>;
  ...
  setSectorIdSectors!: Sequelize.BelongsToManySetAssociationsMixin<Sector, SectorId>;
  addSectorIdSector!: Sequelize.BelongsToManyAddAssociationMixin<Sector, SectorId>;
  addSectorIdSectors!: Sequelize.BelongsToManyAddAssociationsMixin<Sector, SectorId>;
  createSectorIdSector!: Sequelize.BelongsToManyCreateAssociationMixin<Sector>;
  removeSectorIdSector!: Sequelize.BelongsToManyRemoveAssociationMixin<Sector, SectorId>;
  removeSectorIdSectors!: Sequelize.BelongsToManyRemoveAssociationsMixin<Sector, SectorId>;
  hasSectorIdSector!: Sequelize.BelongsToManyHasAssociationMixin<Sector, SectorId>;
  hasSectorIdSectors!: Sequelize.BelongsToManyHasAssociationsMixin<Sector, SectorId>;
  ...
  setSubcategoryIdSubCategories!: Sequelize.BelongsToManySetAssociationsMixin<SubCategory, SubCategoryId>;
  addSubcategoryIdSubCategory!: Sequelize.BelongsToManyAddAssociationMixin<SubCategory, SubCategoryId>;
  addSubcategoryIdSubCategories!: Sequelize.BelongsToManyAddAssociationsMixin<SubCategory, SubCategoryId>;
  createSubcategoryIdSubCategory!: Sequelize.BelongsToManyCreateAssociationMixin<SubCategory>;
  removeSubcategoryIdSubCategory!: Sequelize.BelongsToManyRemoveAssociationMixin<SubCategory, SubCategoryId>;
  removeSubcategoryIdSubCategories!: Sequelize.BelongsToManyRemoveAssociationsMixin<SubCategory, SubCategoryId>;
  hasSubcategoryIdSubCategory!: Sequelize.BelongsToManyHasAssociationMixin<SubCategory, SubCategoryId>;
  hasSubcategoryIdSubCategories!: Sequelize.BelongsToManyHasAssociationsMixin<SubCategory, SubCategoryId>;
  ...
  setSubsectorIdSubSectors!: Sequelize.BelongsToManySetAssociationsMixin<SubSector, SubSectorId>;
  addSubsectorIdSubSector!: Sequelize.BelongsToManyAddAssociationMixin<SubSector, SubSectorId>;
  addSubsectorIdSubSectors!: Sequelize.BelongsToManyAddAssociationsMixin<SubSector, SubSectorId>;
  createSubsectorIdSubSector!: Sequelize.BelongsToManyCreateAssociationMixin<SubSector>;
  removeSubsectorIdSubSector!: Sequelize.BelongsToManyRemoveAssociationMixin<SubSector, SubSectorId>;
  removeSubsectorIdSubSectors!: Sequelize.BelongsToManyRemoveAssociationsMixin<SubSector, SubSectorId>;
  hasSubsectorIdSubSector!: Sequelize.BelongsToManyHasAssociationMixin<SubSector, SubSectorId>;
  hasSubsectorIdSubSectors!: Sequelize.BelongsToManyHasAssociationsMixin<SubSector, SubSectorId>;
