...
Initial function: mean dimension score as headline score (no strength_weight shrink).
SQL inlined as an immutable deploy snapshot (see ba244429bef5 for the update).
"""
