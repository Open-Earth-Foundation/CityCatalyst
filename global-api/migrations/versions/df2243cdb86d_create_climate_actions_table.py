...
def upgrade() -> None:
    op.create_table(
        ...
        sa.CheckConstraint('"CoBenefitsAirQuality" >= -2 AND "CoBenefitsAirQuality" <= 2', 'check_cobenefits_air_quality'),
        sa.CheckConstraint('"CoBenefitsWaterQuality" >= -2 AND "CoBenefitsWaterQuality" <= 2', 'check_cobenefits_water_quality'),
        sa.CheckConstraint('"CoBenefitsHabitat" >= -2 AND "CoBenefitsHabitat" <= 2', 'check_cobenefits_habitat'),
        sa.CheckConstraint('"CoBenefitsCostOfLiving" >= -2 AND "CoBenefitsCostOfLiving" <= 2', 'check_cobenefits_cost_of_living'),
        sa.CheckConstraint('"CoBenefitsHousing" >= -2 AND "CoBenefitsHousing" <= 2', 'check_cobenefits_housing'),
        sa.CheckConstraint('"CoBenefitsMobility" >= -2 AND "CoBenefitsMobility" <= 2', 'check_cobenefits_mobility'),
        sa.CheckConstraint('"CoBenefitsStakeholderEngagement" >= -2 AND "CoBenefitsStakeholderEngagement" <= 2', 'check_cobenefits_stakeholder_engagement'),

        sa.CheckConstraint('"GHGReductionPotentialStationaryEnergy" IS NULL or "GHGReductionPotentialStationaryEnergy" IN (\'0-19\', \'20-39\', \'40-59\', \'60-79\', \'80-100\')', 'check_ghg_reduction_potential_stationary_energy'),

        sa.CheckConstraint('"GHGReductionPotentialTransportation" IS NULL or "GHGReductionPotentialTransportation" IN (\'0-19\', \'20-39\', \'40-59\', \'60-79\', \'80-100\')', 'check_ghg_reduction_potential_transportation'),

        sa.CheckConstraint('"GHGReductionPotentialWaste" IS NULL or "GHGReductionPotentialWaste" IN (\'0-19\', \'20-39\', \'40-59\', \'60-79\', \'80-100\')', 'check_ghg_reduction_potential_waste'),

        sa.CheckConstraint('"GHGReductionPotentialIPPU" IS NULL or "GHGReductionPotentialIPPU" IN (\'0-19\', \'20-39\', \'40-59\', \'60-79\', \'80-100\')', 'check_ghg_reduction_potential_ippu'),

        sa.CheckConstraint('"GHGReductionPotentialAFOLU" IS NULL or "GHGReductionPotentialStationaryEnergy" IN (\'0-19\', \'20-39\', \'40-59\', \'60-79\', \'80-100\')', 'check_ghg_reduction_potential_afolu'),

        sa.CheckConstraint('"AdaptationEffectiveness" IS NULL OR "AdaptationEffectiveness" IN (\'high\', \'medium\', \'low\')', 'check_adaptation_effectiveness'),

        sa.CheckConstraint('"CostInvestmentNeeded" IS NULL OR "CostInvestmentNeeded" IN (\'high\', \'medium\', \'low\')', 'check_cost_investment_needed'),

        sa.CheckConstraint('"TimelineForImplementation" IS NULL OR "TimelineForImplementation" IN (\'<5 years\', \'5-10 years\', \'>10 years\')', 'check_timeline_for_implementation'),
    )
    op.execute(
        """
