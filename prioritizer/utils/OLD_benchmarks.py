...
def get_accuracy_expert_vs_quanti(df: pd.DataFrame, actions: list) -> float:
    ...
    for _, row in df.iterrows():
        ...
        print("actionA_with_context: ", actionA_with_context)
        print("actionB_with_context: ", actionB_with_context)
...
def get_accuracy_expert_vs_quali(df: pd.DataFrame, actions: list) -> float:
    ...
    for index, row in df.iterrows():
        ...
        input("Press Enter to continue LLM 2")
        print("row: ", row)
        ...
        input("Press Enter to continue LLM 3")
        print("city_data: ", city_data)
        print("actionA: ", actionA)
        print("actionB: ", actionB)
        ...
        input("Press Enter to continue LLM 4")
        print("actionA_with_context: ", actionA_with_context)
        print("actionB_with_context: ", actionB_with_context)
        ...
        if actionA_with_context and actionB_with_context:
            ...
            if qual_score:
                ...
                input("Press Enter to continue LLM 5")
                print("quia_score: ", qual_score)
