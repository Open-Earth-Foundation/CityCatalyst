...
# new column names
new_col = ['Region_Country_Economy',
...
#replace null values
sheet2 = sheet2.replace({'..': 0, '-': 0}) # These changes don't mean that emissions are 0, it's only for not having problems with arithmetic operations
...
df1 = pd.melt(df1, id_vars=['Region_Country_Economy', 'year'], 
...
df2 = pd.melt(df2, id_vars=['Region_Country_Economy', 'year'], 
             value_vars=subsector_names, 
             var_name='activity_name', 
             value_name='emissions_value')

sheet2['year'] = 2021
sheet2 = pd.melt(sheet2, id_vars=['Region_Country_Economy', 'year'], 
             value_vars=subsector_names, 
             var_name='activity_name', 
             value_name='emissions_value')
...
values_to_remove = ['OECD Americas', 'OECD Asia Oceania', 'OECD Europe', 'Russian Federation', 'Non-OECD Europe and Eurasia', 
 'Asia (excl. China)', "People's Rep. of China", 'Non-OECD Americas', 'Middle East', 'European Union - 27', 
 'G7', 'G8', 'Americas', 'Former Soviet Union (if no detail)', 'Hong Kong, China', 'Gibraltar',
 'Former Yugoslavia (if no detail)', 'Other Africa', 'Chinese Taipei', 'Other Asia', 'Other Non-OECD Americas', 
 'IEA/Accession/Association', 'G20', 'Asia', 'Europe', 'Oceania']
...
to_change = ['Dem. Rep. of Congo', 'Kingdom of Eswatini', 'United Rep. of Tanzania', 'Islamic Rep. of Iran', 
 'Slovak Republic', 'Republic of Türkiye','Republic of North Macedonia', 'DPR of Korea', 
 'China (incl. Hong Kong, China)']
new = ['Congo', 'Eswatini', 'Tanzania', 'Iran', 'Slovak', 'Türkiye','North Macedonia', 'Korea', 'China']
