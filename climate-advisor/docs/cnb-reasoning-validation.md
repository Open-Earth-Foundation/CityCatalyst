...
Validated locally on 16 September 2026 for CC-827. This documents the delivery
fix, the provider comparison, and what the change cannot guarantee.
...
- 85 backend tests passed; four manual integration cases skipped.
- 17 frontend chat/rendering/SSE tests passed; scoped frontend ESLint passed.
- TypeScript passed. Broader scoped Ruff has 42 existing findings, verified
  against HEAD; new helpers and scripts pass their Ruff checks.
