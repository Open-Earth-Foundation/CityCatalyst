...
| **Implement**                  | Turn plans into bankable projects           | _(partner modules)_        |
| **Monitor, Evaluate & Report** | Track and report progress                   | _(partner modules)_        |
...
- **Client SDKs** — generated from the OpenAPI spec (TypeScript & Python) via CI. _(Generated in CI; not yet published to a public registry.)_
