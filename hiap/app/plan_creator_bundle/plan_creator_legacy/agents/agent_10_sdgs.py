...
from plan_creator_bundle.plan_creator_legacy.data.context import sdgs
...
def build_custom_agent_10():
    ...
    react_chain = create_agent(model, tools, system_prompt=agent_10_system_prompt)
