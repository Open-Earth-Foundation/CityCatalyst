...
UI_LABELS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "export_anyway": "Export anyway (with missing information)",
    ...
    "de": {
        ...
        "export_anyway": "Trotzdem exportieren (mit fehlenden Informationen)",
    ...
    "es": {
        ...
        "export_anyway": "Exportar de todos modos (con información faltante)",
    ...
    "fr": {
        ...
        "export_anyway": "Exporter quand même (avec des informations manquantes)",
    ...
    "pt": {
        ...
        "export_anyway": "Exportar mesmo assim (com informação em falta)",
