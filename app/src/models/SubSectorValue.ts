...
export type SubSectorValueOptionalAttributes =
  | "activityUnits"
  | "activityValue"
  | "emissionFactorValue"
  | "totalEmissions"
...
export type SubSectorValueCreationAttributes = Optional<
  ...
  SubSectorValueOptionalAttributes
>;

export class SubSectorValue
  extends Model<SubSectorValueAttributes, SubSectorValueCreationAttributes>
  implements SubSectorValueAttributes
{
  subsectorValueId!: string;
  activityUnits?: string;
  activityValue?: number;
  ...
  // SubSectorValue hasMany SubCategoryValue via subsectorValueId
        ...
        indexes: [
          {
            ...
            unique: true,
            fields: [{ name: "subsector_value_id" }],
          },
        ],
      },
    );
