...
import { OAuthClientI18N, OAuthClientI18NAttributes } from "@/models/OAuthClientI18N";
import {
      ...
      for (const testClient of testClients) {
        ...
        for (const clientI18N of clientI18Ns) {
          ...
          if (clientI18N.description) {
            ...
            expect(client.description[clientI18N.language]).toEqual(clientI18N.description)
          } else {
