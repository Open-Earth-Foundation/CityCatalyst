...
export interface HighImpactActionRankedAttributes {
  ...
  description?: string;
  dependencies?: string[];
  cobenefits?: Record<string, object>;
  equityAndInclusionConsiderations?: string;
  GHGReductionPotential?: Record<string, object>;
  adaptationEffectiveness?: string;
  adaptationEffectivenessPerHazard?: Record<string, object>;
  ...
  implements HighImpactActionRankedAttributes
{
  ...
  declare cobenefits?: Record<string, object>;
  declare equityAndInclusionConsiderations?: string;
  declare GHGReductionPotential?: Record<string, object>;
  declare adaptationEffectiveness?: string;
  declare adaptationEffectivenessPerHazard?: Record<string, object>;
