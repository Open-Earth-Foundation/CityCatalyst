...
export const ccraTranslationKeys = {
  ...
  floods: "hazard-flooding",
  droughts: "hazard-drought",
  wildfires: "hazard-wildfire",
  cyclone: "hazard-cyclone",
  sea_level_rise: "hazard-sea-level-rise",
  heatwaves: "hazard-heatwaves",
  diseases: "hazard-diseases",
  landslides: "hazard-landslides",

  // Sectors
  health: "sector-health",
  public_health: "sector-public-health",
  food_security: "sector-food-security",
  water_resources: "sector-water-resources",
  energy_security: "sector-energy-security",
  biodiversity: "sector-biodiversity",
