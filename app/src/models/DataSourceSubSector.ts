...
export type DataSourceSubSectorCreationAttributes = Optional<
  DataSourceSubSectorAttributes,
  DataSourceSubSectorOptionalAttributes
>;

export class DataSourceSubSector
  extends Model<
    DataSourceSubSectorAttributes,
    DataSourceSubSectorCreationAttributes
  >
  implements DataSourceSubSectorAttributes
{
  datasourceId!: string;
  subsectorId!: string;
  created?: Date;
        ...
        indexes: [
          {
            ...
            unique: true,
            fields: [{ name: "datasource_id" }, { name: "subsector_id" }],
          },
        ],
      },
    );
