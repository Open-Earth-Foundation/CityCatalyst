...
# TODO: Define what MER indicators are. E.g. what are we looking for here as output?
...
<task>
You are tasked with creating 'monitoring, evaluation and reporting (MER) indicators' for implementing the climate action (main action) and sub-actions for the given city with the given milestones, timeline and cost and budget considerations. 
...
7. Review the cost and budget considerations for the implementation of the climate action that you are provided with.
8. Based on the main action, sub-actions, the milestones, timeline and cost and budget considerations for the implementation of the climate action for the given city, create 'monitoring, evaluation and reporting (MER) indicators' for the implementation of the climate action.
</task>
...
def build_custom_agent_7(model, tools):
    """Wrap create_react_agent to store final output in AgentState."""

    # The chain returned by create_react_agent
    react_chain = create_react_agent(model, tools, state_modifier=system_prompt_agent_7)
